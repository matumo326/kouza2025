  ...
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        ...
        22,
        "*"))
      .appendField("スイッチGP20が押された");
    this.setOutput(true, null);
    this.setColour(160);
 this.setTooltip("スイッチGP20が押された");
//  this.setHelpUrl("http://www.bipes.net.br");
  }
};
Blockly.Blocks['switch21_get'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        "media/switch.png",
        ...
        22,
        "*"))
      .appendField("スイッチGP21が押された");
    this.setOutput(true, null);
    this.setColour(160);
 this.setTooltip("スイッチGP21が押された");
//  this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['switch14_get'] = {
  init: function() {
    this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        "media/Tactile_Switch.png",
        22,
        22,
        "*"))
      .appendField("スイッチが押された");
    this.setOutput(true, null);
    this.setColour(160);
 this.setTooltip("スイッチが押された");
//  this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['touch_get'] = {
  init: function() {
    ...
    this.setOutput(true, null);
    this.setColour(160);
 this.setTooltip("タッチスイッチがタッチされた");
//  this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['pwm_pico'] = {
  ...
  init: function(){
    this.appendDummyInput()
        .appendField("PWMで出力  PWM#")
        .appendField(new Blockly.FieldNumber(18, 0, 50, 1), "ID");
    this.appendValueInput("pin")
        .setCheck(null)
	      .appendField("ピン");
    this.appendValueInput("frequency")
        .setCheck("Number")
	      .appendField("周波数(1Hz～40MHz)");
    this.appendValueInput("duty")
        .setCheck("Number")
	      .appendField("デューティ(0～65,535)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(190);
    this.setTooltip("周波数(1Hz～40MHz)とデューティ(0～65,535)でPWMを初期化し、設定します");
    this.setHelpUrl("https://docs.micropython.org/en/latest/esp32/quickref.html#pwm-pulse-width-modulation");
 },
  setID: function(id_) {
    this.setFieldValue(id_, "ID")
...
Blockly.Blocks['pwm_pico_percent'] = {
  warning_: new Array(2).fill(true),
  init: function(){
    this.appendDummyInput()
        .appendField("PWMで出力  PWM#")
    ...
    this.appendValueInput("frequency")
        .setCheck("Number")
	      .appendField("周波数(10Hz～40MHz)");
    this.appendValueInput("duty")
        .setCheck("Number")
	      .appendField("デューティ(0～100%)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(190);
    this.setTooltip("周波数(10Hz～40MHz)とデューティ(0～65,535)でPWMを初期化し、設定します");
    this.setHelpUrl("https://docs.micropython.org/en/latest/esp32/quickref.html#pwm-pulse-width-modulation");
 },
  setID: function(id_) {
    this.setFieldValue(id_, "ID")
...
Blockly.Blocks['pwm.freq'] = {
  ...
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setColour(190);
    this.setTooltip("周波数(1Hz～40MHz)を設定します");
    this.setHelpUrl("https://docs.micropython.org/en/latest/esp32/quickref.html#pwm-pulse-width-modulation");
  },
  check (value, id) {
    Tool.warningIfTrue (this, [
...
Blockly.Blocks['pwm.duty_pico'] = {
  ...
  init: function() {
    this.appendValueInput('duty')
        ...
        .appendField("PWM #")
        .appendField(new Blockly.FieldNumber(0, 0, 50, 1), "ID")
        .appendField("デューティ(0～65,536)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(190);
    this.setTooltip("デューティ(0～65,536)で設定します");
    this.setHelpUrl("https://docs.micropython.org/en/latest/esp32/quickref.html#pwm-pulse-width-modulation");
  },
  check (value, id) {
    Tool.warningIfTrue (this, [
...
Blockly.Blocks['pwm.duty_pico_percent'] = {
  warning_: new Array(2).fill(true),
  init: function() {
    this.appendValueInput('duty')
        .setCheck('Number')
    ...
    this.setNextStatement(true, null);
    this.setColour(190);
    this.setTooltip("デューティ(0～100%)で設定します");
    this.setHelpUrl("https://docs.micropython.org/en/latest/esp32/quickref.html#pwm-pulse-width-modulation");
  },
  check (value, id) {
    Tool.warningIfTrue (this, [
...
Blockly.Blocks['delay_us'] = {
  init: function() {
    this.appendValueInput("time")
        .setCheck("Number")
        .appendField("まつ (マイクロ秒)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("数字のマイクロ秒だけまつ");
 this.setHelpUrl("http://www.bipes.net.br/");
  }
};
...
Blockly.Blocks['ticks_ms'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("現在までのミリ秒カウンターの値"), "MSG_GET_MS");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("呼出し時点での稼働時間をミリ秒単位で返す");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['ticks_us'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("現在までのマイクロ秒カウンターの値"), "MSG_GET_MS");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("呼出し時点での稼働時間をマイクロ秒単位で返す");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['ticks_diff'] = {
  init: function() {
   this.appendDummyInput().appendField(new Blockly.FieldLabelSerializable("稼働時間の差を求める"), "DIFF_TS");
    this.setOutput(true, null);
...
Blockly.Blocks['timer'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        // .appendField(new Blockly.FieldNumber(2, 0, 9, 1), "timerNumber")
        .appendField("実行")
        .appendField(new Blockly.FieldDropdown([["ずっと","PERIODIC"], ["1回だけ","ONE_SHOT"]]), "MODE")
...
//     this.appendValueInput("pin")
//         .setCheck("Number")
//         .appendField("アナログでよみこむ");
//     this.setOutput(true, null);
//     this.setColour(190);
//  this.setTooltip("ピンからアナログでよみこむ");
//  this.setHelpUrl("http://www.bipes.net.br");
//   }
// };
...
Blockly.Blocks['gpio_get'] = {
  init: function() {
    this.appendValueInput("pin")
        .setCheck("Number")
        .appendField("デジタルでよみこむ");
    this.setOutput(true, null);
    this.setColour(190);
 this.setTooltip("ピンからデジタルでよみこむ");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['gpio_interrupt'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("ピンによる外部割込み");
    this.appendDummyInput()
        .appendField("トリガー:")
        .appendField(new Blockly.FieldDropdown([["立下りエッジ","IRQ_FALLING"], ["立上りエッジ","IRQ_RISING"], ["両方のエッジ","BOTH"]]), "trigger");
    this.appendValueInput("pin")
        .setCheck(null)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("ピン");
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
 this.setTooltip("ピンに変化があった時、割込みを実行する");
 this.setHelpUrl("bipes.net.br");
  }
};
...
Blockly.Blocks['pinout'] = {
  update_list: function(load_) {
    ...
    if (device_ !== device_init_)
      ...
      this.setColour(190);  // this.setDisabled causes all modifiers to stop working at the workspace, using visual colour feedback instead.
...
Blockly.Blocks['mpu6050_read_acc_x'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("X軸の加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("X軸の加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['mpu6050_read_acc_y'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Y軸の加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Y軸の加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['mpu6050_read_acc_z'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Z軸の加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Z軸の加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['mpu6050_read_gyro_x'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("X軸の角加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("X軸の角加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['mpu6050_read_gyro_y'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Y軸の角加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Y軸の角加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['mpu6050_read_gyro_z'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Z軸の角加速度"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("Z軸の角加速度");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
//VL53L0
Blockly.Blocks['init_vl53l0'] = {
  init: function() {
    this.setColour(135);
    this.appendDummyInput()
        .appendField("距離センサーの初期化");
 ...
 this.appendDummyInput()
      .appendField(new Blockly.FieldImage(
        ...
        .appendField(new Blockly.FieldDropdown([
          ["I2C0 [GP1,GP0]"	,	"0,1,0"	],
          ["I2C0 [GP5,GP4]"	,	"0,5,4"	],
          ["I2C0 [GP17,GP16]"	,	"0,17,16"	],
          ["I2C1 [GP3,GP2]"	,	"1,3,2"	],
          ["I2C1 [GP27,GP26]"	,	"1,27,26"	]
        ]),
        "i2c_pin");
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('距離センサーVL53L01を初期化する');
  }
};


Blockly.Blocks['vl53l0_read_distance'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("距離(mm)"), "MSG_READ_MPU6050");
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("距離センサーからの距離を測定");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
//End VL53L0
...
Blockly.Blocks['move_servo'] = {
 ...
 this.appendDummyInput().appendField("サーボ回転");
    this.appendValueInput("pin")
        .setCheck("Number")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("ピン");
...
Blockly.Blocks['project_metadata'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("プロジェクト情報"), "NAME");
    this.appendValueInput("project_author")
        .setCheck("String")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldLabel("作者の名前"), "project_author");
    ...
    this.appendValueInput("project_description")
        .setCheck("String")
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldLabel("プログラムの名前"), "project_description");
    this.setColour(230);
...
Blockly.Blocks['neopixel_init'] = {
 ...
 this.appendDummyInput()
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip("NeoPixelを制御するピンと個数を設定する");
  }
};
...
Blockly.Blocks['neopixel_control'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelの位置と色を設定"), "MSG_NEOPIXEL");
    ...
    this.setColour(40);
 this.setTooltip("NeoPixelの位置と色を指定して設定");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};

Blockly.Blocks['neopixel_control_line'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelを連続で色設定"), "MSG_NEOPIXEL");

    this.appendValueInput("start_address")
        .setCheck(null)
        .setAlign(Blockly.ALIGN_RIGHT)
	      .appendField("開始位置");

    this.appendValueInput("end_address")
        .setCheck(null)
        .setAlign(Blockly.ALIGN_RIGHT)
	      .appendField("終了位置");
...
Blockly.Blocks['neopixel_control_all'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("全てのNeoPixelの色を設定"), "MSG_NEOPIXEL");
    ...
    this.setColour(40);
 this.setTooltip("全てのNeoPixelの色を設定");
 this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['neopixel_rotate_left'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelをもどす"), "MSG_NEOPIXEL");
...
Blockly.Blocks['neopixel_rotate_right'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelをすすめる"), "MSG_NEOPIXEL");
...
Blockly.Blocks['neopixel_write'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabel("NeoPixelを点灯"), "MSG_NEOPIXEL");

    this.setPreviousStatement(true);
    this.setNextStatement(true);

    this.setColour(40);
    this.setTooltip("NeoPixelを点灯");
    this.setHelpUrl("http://www.bipes.net.br");
  }
};
...
Blockly.Blocks['neopixel_color_numbers'] = {
  init: function() {
    ...
    this.setOutput(true, null);
    this.setColour(40);
    this.setTooltip("NeoPixelの色をRGBで指定");
...
Blockly.Blocks['HSL_to_RGB'] = {
  init: function  () {
    ...
    this.setOutput(true, null);
    this.setColour(40);
    this.setTooltip("色相は0º～360º, 彩度と輝度は0%～100%で指定する");
    this.setHelpUrl("https://bipes.net.br/wp/?page_id=177");
  },
